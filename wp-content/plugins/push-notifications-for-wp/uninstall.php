...
function pnfw_delete_plugin() {
 ...
 delete_option('pnfw_safari_push_notifications');
 ...
 delete_option('pnfw_safari_p12_certificate_media_id');
 delete_option('pnfw_safari_p12_certificate_password');
 delete_option('pnfw_safari_pem_certificate_media_id');
 delete_option('pnfw_safari_pem_certificate_password');
 delete_option('pnfw_safari_icon_16_media_id');
 delete_option('pnfw_safari_icon_32_media_id');
 delete_option('pnfw_safari_icon_64_media_id');
 delete_option('pnfw_safari_icon_128_media_id');
 delete_option('pnfw_safari_icon_256_media_id');
 delete_option('pnfw_safari_website_push_id');
