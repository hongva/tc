...
define("TD_THEME_VIDEO_TUTORIALS_URL", "https://www.youtube.com/watch?v=TUdVeZ1pbuc&list=PL6CsDkMaejhpWFcFNOIDfdp5nIT0NbUbj");
...
class td_config {
    ...
    static function on_td_global_after_config() {
        ...
        td_global::$js_files = array(
            ...
            'td_hash_scroll' =>         '/includes/js_files/td_hash_scroll.js',
        ...
        */
        ...
        td_global::$default_google_fonts_list = array (
            ...
            '522' => array(
                ...
                'url' => td_global::$http_or_https . '://fonts.googleapis.com/css?family=Roboto+Condensed:300italic,400italic,700italic,400,300,700'
            ),
        );
        ...
        if (is_admin()) {
	        ...
	        td_global::$td_wp_admin_text_list = array(
		        ...
		        'text_header_logo_description' => 'The text logo is used only by Style 10 - full menu + text logo. The other header styles use only images for logos',

		        'text_header_logo_mobile' => 'Style 4, Style 5 or Style 9',

		        'text_header_logo_mobile_image' => '230 x 90px',

		        'text_header_logo_mobile_image_retina' => '460 x 180px',
